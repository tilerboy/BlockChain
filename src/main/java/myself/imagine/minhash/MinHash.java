...
public class MinHash {
	...
	protected static double minHashJaccard(int k, Set<String> set) throws IOException {
		Set<String> set1 = getSet(k, KShingle.eth_add_a);
		Set<String> set2 = getSet(k, KShingle.eth_add_b);
		...
		System.out.println(
				"第一项与第二项得到最小哈希值相等的概率计算为P = " + equalHashValue + " / " + set.size() + " = " + df.format(result));
